...
public class managertb {
	...
	public managertb(int id, String manager_id , String manager_name, String manager_password, String manager_gmail, String complex_name,
			String complex_id) {
		super();
		this.id = id;
	...
	public String toString() {
		return "managertb [id=" + id + ", manager_id=" + manager_id + ", manager_name=" + manager_name
				...
				+ complex_name + ", complex_id=" + complex_id + "]";
	}
